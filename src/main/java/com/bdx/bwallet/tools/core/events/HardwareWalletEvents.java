...
import com.bdx.bwallet.tools.core.ExceptionHandler;
...
/**
 * <p>
 * Factory to provide the following to application API:</p>
 * <ul>
 * <li>Entry point to broadcast high level hardware wallet events to downstream
 * consumers</li>
 * </ul>
 *
 * @since 0.0.1  
...
public class HardwareWalletEvents {
    ...
    /**
     * <p>
     * Subscribe to events. Repeating a subscribe will not affect the event
     * bus.</p>
     * <p>
     * This approach ensures all subscribers will be correctly removed during a
     * shutdown or wizard hide event</p>
     *
     * @param subscriber The subscriber (use the Guava <code>@Subscribe</code>
     * annotation to subscribe a method)
     */
    ...
    /**
     * <p>
     * Unsubscribe a known subscriber from events. Providing an unknown object
     * will not affect the event bus.</p>
     * <p>
     * This approach ensures all subscribers will be correctly removed during a
     * shutdown or wizard hide event</p>
     *
    ...
    /**
     * <p>
     * Unsubscribe all subscribers from events</p>
     * <p>
     * This approach ensures all subscribers will be correctly removed during a
     * shutdown or wizard hide event</p>
     */
    ...
    /**
     * <p>
     * A hardware event can wrap a hardware wallet message adapted from a
     ...
     */
    public static void fireHardwareWalletEvent(final HardwareWalletEventType eventType, final Message message) {
    ...
    /**
     * <p>
     * A hardware event can have no further information</p>
     *
     * @param eventType The event type (e.g. SHOW_DEVICE_READY)
     */
