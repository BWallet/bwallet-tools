...
public class MultiSignTxFlow extends AbstractWalletFlow {
	...
	protected void internalTransition(WalletClient client, WalletContext context, MessageEvent event) {
        ...
        case TX_REQUEST:
            ...
            client.multiTxAck(txRequest, transaction, context.getReceivingAddressPathMap(), context.getChangeAddressPathMap(), context.getPubkeys(), context.getMultisigBasePath(), context.getMultisigM(), context.getMultisigSignatures());
            break;
        case BUTTON_REQUEST:
