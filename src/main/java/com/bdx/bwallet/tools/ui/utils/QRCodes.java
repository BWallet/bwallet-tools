...
/**
 * <p>
 * Utilities to provide the following to UI:</p>
 * <ul>
...
public class QRCodes {
    ...
    /**
     * <p>
     * Generate a QR code encoding the given contents</p>
     *
     * @param contents The text to be encoded into the QR code (e.g. a canonical
     * Bitcoin URI)
     * @param scaleFactor The scaling factor providing number of pixels per QR
     * element
     *
    ...
    /**
     * <p>
     * Create a ByteMatrix representing the contents for use as the input
     * matrix</p>
     *
     * @param contents The text to be encoded into the QR code (e.g. a canonical
     * Bitcoin URI)
    ...
    /**
     * <p>
     * The input matrix uses 0 == white, 1 == black</p>
     * <p>
     * The output matrix uses 0 == black, 255 == white (i.e. an 8 bit greyscale
     * bitmap)</p>
     *
     * @param code The QR code
     * @param multiple The scaling multiple (number of pixels to allocate to
     * each element)
     *
